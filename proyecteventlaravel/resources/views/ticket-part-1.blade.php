...
<body>
    ...
    <div class="container event-buy-ticket">
        <div class="row">
            ...
            <aside class="col-sm-4">
				...
				<!-- Disponibles <span id="disponible"> -->
                <p class="text-right">Disponibles:<span id="disponible"></span></p>
				<a id="boton-compra" href="{{route('ticketpart2')}}" class="btn btn-primary">Confirmar compra</a>
  ...
  <script src="<?php echo asset('js/ticket-part-1.js')?>"></script>
